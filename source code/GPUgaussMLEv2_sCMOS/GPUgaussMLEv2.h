...
__global__ void kernel_MLEFit_noshared(const float *d_data, float *d_Coords, const float *d_GainRatio, const float PSFSigma,
	    const int sz, const int Mapsz, const int iterations, 
