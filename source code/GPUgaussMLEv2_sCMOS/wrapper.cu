...
//*******************************************************************************************
extern void kernel_MLEFit_noshared_wrapper(dim3 dimGrid, dim3 dimBlock, const float *d_data, float *d_Coords, const float *d_GainRatio, 
 ...
 */
	...
	kernel_MLEFit_noshared<<<dimGrid, dimBlock>>>(d_data, d_Coords, d_GainRatio, PSFSigma, sz, Mapsz, iterations, d_Parameters, d_CRLBs, d_LogLikelihood, Nfits);
}
...
//*******************************************************************************************
extern void kernel_MLEFit_sigma_wrapper(dim3 dimGrid, dim3 dimBlock, const float *d_data, float *d_Coords, const float *d_GainRatio, 
		const float PSFSigma, const int sz, const int Mapsz, const int iterations, 
        float *d_Parameters, float *d_CRLBs, float *d_LogLikelihood,const int Nfits) 
{
/*!
 ...
 *  \param Nfits number of subregions to fit
 */
	kernel_MLEFit_sigma<<<dimGrid, dimBlock>>>(d_data, d_Coords, d_GainRatio, PSFSigma, sz, Mapsz, iterations, d_Parameters, d_CRLBs, d_LogLikelihood, Nfits);
}

//*******************************************************************************************
extern void kernel_MLEFit_z_wrapper(dim3 dimGrid, dim3 dimBlock, const float *d_data, float *d_Coords, const float *d_GainRatio, float *d_x0,
 ...
 *  \param Nfits number of subregions to fit
 */
	kernel_MLEFit_z<<<dimGrid, dimBlock>>>(d_data, d_Coords, d_GainRatio, d_x0, PSFSigma_x, Ax, Ay, Bx, By, gamma, d, PSFSigma_y, sz, Mapsz, iterations, d_Parameters, d_CRLBs, d_LogLikelihood, Nfits);
}

//*******************************************************************************************
extern void kernel_MLEFit_sigmaxy_wrapper(dim3 dimGrid, dim3 dimBlock, const float *d_data, float *d_Coords, const float *d_GainRatio,
		const float PSFSigma, const int sz, const int Mapsz, const int iterations, 
        float *d_Parameters, float *d_CRLBs, float *d_LogLikelihood,const int Nfits) 
{
	/*!
 ...
 *  \param Nfits number of subregions to fit
 */
	kernel_MLEFit_sigmaxy<<<dimGrid, dimBlock>>>(d_data, d_Coords, d_GainRatio, PSFSigma, sz, Mapsz, iterations, d_Parameters, d_CRLBs, d_LogLikelihood, Nfits);
}