// mexFunction for PR-4Pi localization based on linear interpolation with 5 fitting parameters:x,y,z,I,bg
// call mex function in Matlab:
// [P,CG,crlb,err,PSF] = cuda4pi_loc_linear_consI(data,cor,PSFsi,SampleSpacingXY,SampleSpacingZ,StartX,StartY,StartZ,iterateNum,Nfit,lambda0,xIn,gainR);
// 
