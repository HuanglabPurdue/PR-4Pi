// mexFunction for PR-4Pi localization based on spline interpolation with 11 fitting parameters:x,y,z,I1,I2,I3,I4,bg1,bg2,bg3,bg4
// call mex function in Matlab:
// [P,CG,crlb,err,PSF] = cuda4pi_loc_spline(data,cor,PSFsi,SampleSpacingXY,SampleSpacingZ,StartX,StartY,StartZ,iterateNum,Nfit,lambda0,xIn,gainR,...
